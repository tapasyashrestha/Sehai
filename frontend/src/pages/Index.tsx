...
import { Activity, Mic, Heart, CheckCircle, Globe, Moon, Sun, Mail, Phone } from 'lucide-react'
        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-cyan-50 dark:to-cyan-950">
                ...
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-4">
                            <a href="#about" className="text-sm hover:text-primary transition-colors hidden sm:inline">
                                About
                            </a>
                            <a href="#contact" className="text-sm hover:text-primary transition-colors hidden sm:inline">
                                Contact
                            </a>
            ...
            <section id="about" className="container mx-auto px-4 py-20">
                <div className="max-w-3xl mx-auto text-center space-y-6">
                    <h2 className="text-3xl font-bold">About SEHAI</h2>
                    <p className="text-lg text-muted-foreground">
                        SEHAI (Smart Electronic Health AI) is an AI-powered platform designed to bridge the healthcare
                        gap in rural India. By combining voice-enabled data entry, intelligent symptom analysis, and a
                        seamless referral chain from Sub-Centres to PHCs to CHCs, SEHAI empowers frontline health
                        workers to deliver faster, more accurate patient care — even in resource-limited settings.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                        <div className="p-6 rounded-xl bg-card border">
                            <p className="text-3xl font-bold text-primary mb-2">133</p>
                            <p className="text-sm text-muted-foreground">Symptoms Recognized</p>
                        </div>
                        <div className="p-6 rounded-xl bg-card border">
                            <p className="text-3xl font-bold text-primary mb-2">40+</p>
                            <p className="text-sm text-muted-foreground">Diseases Predicted</p>
                        </div>
                        <div className="p-6 rounded-xl bg-card border">
                            <p className="text-3xl font-bold text-primary mb-2">3-Tier</p>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 rounded-xl bg-card border text-center">
                            ...
                            <a href="mailto:support@sehai.in" className="text-primary hover:underline">support@sehai.in</a>
                        </div>
                        <div className="p-6 rounded-xl bg-card border text-center">
                            <Phone className="h-8 w-8 text-primary mx-auto mb-3" />
                            <h3 className="font-semibold mb-2">Phone</h3>
                            <a href="tel:1800-123-4567" className="text-primary hover:underline">1800-123-4567</a>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-muted-foreground">
                            © 2026 SEHAI - Improving Rural Healthcare Access
                        </p>
